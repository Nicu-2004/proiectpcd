...
/* Definim o constanta pentru float separat pentru a evita magic numbers */
...
/* --- Functie auxiliara pentru formatare (scade complexitatea) --- */
...
/* --- Functie auxiliara pentru eroare (scade complexitatea) --- */
